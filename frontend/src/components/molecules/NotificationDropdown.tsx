        ...
        >
            <div className='rounded-lg bg-white py-2.5 ring-1 ring-black/5'>
                ...
                >
                    ...
                    <p className='text-xs text-neutral-500'>
                        Your recently resolved ticket regarding account recovery
                        has been flagged for quality review. Please provide your
                        feedback.
                    </p>
                </a>
                ...
                >
                    ...
                    <p className='text-xs text-neutral-500'>
                        Your support performance metrics for the past month are
                        now available. Review them for insights on response
