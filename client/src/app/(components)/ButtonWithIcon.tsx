...
const PrimaryOutlineSemiRoundedButtonWithIcon = (props: IProps) => {
  const { handleClick, title } = props;
  return (
    <button
      onClick={handleClick}
      className="border-primary hover:bg-blue-light-5 hover:text-body-color disabled:bg-gray-3 disabled:border-gray-3 disabled:text-dark-5 active:bg-blue-light-3 inline-flex items-center justify-center rounded-md border bg-slate-700 px-5 py-3 text-center text-base font-medium text-white"
    >
